...
/* Initial stack and malloc pool, defined from the top */
#define CONFIG_SYS_INIT_SP_ADDR         (ATMEL_BASE_SRAM1 + SZ_32K)
...
#define CONFIG_SPL_BSS_START_ADDR       ATMEL_BASE_SRAM1
